...
const Slidebar = () => {
  ...
  return (
    ...
    <div className='sli6'><button type='button' onClick={()=>{navigate('/Dashboard5')}} style={{borderRadius:"20px",width:"12vw",height:"6vh",color:'black',backgroundColor:'white',cursor:'pointer'}}>Calender<CalendarMonthIcon/></button></div>
    ...
    <div className='sli5'><img src='https://robisearch.com/wp-content/uploads/2021/05/Task-Logo-fullcol-Copy-561x480.png'  style={{height:'20vh',width:"20vw"}}/></div>
